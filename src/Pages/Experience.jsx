...
const Experience = () => {
  return (
    <>
       <section className="section experience" id="four">
            <div className="section__inner">
                <div className="anim-wrapper">
                    <svg className="background__lights" id="lines" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1920 1080" xmlSpace="preserve"
                        ...
                        <div className="row">
                            <div className="col-lg-10 col-xl-8">
                                <div className="experience__content" data-aos="fade-right">
                                    ...
                                    <div className="experience__content-tab">
                                        <div className="experience__content-tab-btns">
                                            <a href="#exp" className="tab-btn tab-btn-active">
                                                Ericsson
                                            </a>
                                            <a href="#secondExp" className="tab-btn">
                                                Facebook
                                            </a>
                                            <a href="#thirdExp" className="tab-btn">
                                                Duff Beer
                                            </a>
                                            <a href="#fourthExp" className="tab-btn">
                                                Initech
                                            </a>
                                            <a href="#fifthExp" className="tab-btn">
                                                Hooli
                                            </a>
                                            <a href="#sixthExp" className="tab-btn">
                                                SingTel
                                            </a>
                                            <a href="#seventhExp" className="tab-btn">
                                                Fortive
                                            </a>
                                        </div>
                                        <div className="experience__content-tab-content" id="exp">
                                            <h5>Engineer <span>@Ericsson</span></h5>
                                            <p>May 2018 - Present</p>
                                            <ul>
                                                <li><i className="fa-solid fa-caret-right"></i>Write modern, performant,
                                                    maintainable code for a diverse array of
                                                    client and internal projects</li>
                                                <li><i className="fa-solid fa-caret-right"></i>Work with a variety of
                                                ...
                                                <li><i className="fa-solid fa-caret-right"></i>Communicate with
                                                    multi-disciplinary teams of engineers, designers,
                                                    producers, and clients on a daily basis</li>
                                            </ul>
                                        </div>
                                        <div className="experience__content-tab-content" id="secondExp">
                                        ...
                                        <div className="experience__content-tab-content" id="thirdExp">
                                        ...
                                        <div className="experience__content-tab-content" id="fourthExp">
                                        ...
                                        <div className="experience__content-tab-content" id="fifthExp">
                                        ...
                                        <div className="experience__content-tab-content" id="sixthExp">
                                        ...
                                        <div className="experience__content-tab-content" id="seventhExp">
